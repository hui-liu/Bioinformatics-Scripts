samtools faidx ../$1.asm.hic.$2.p_ctg.fa
awk '$2<5000000' ../$1.asm.hic.$2.p_ctg.fa.fai | \
cut -f 1 | samtools faidx ../$1.asm.hic.$2.p_ctg.fa -r - > $2.Contig.fasta
...
python ~/bin/scripts/remove_seqs_by_ids.py ../$1.asm.hic.$2.p_ctg.fa \
