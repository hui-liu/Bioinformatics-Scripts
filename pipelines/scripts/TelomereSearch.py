...
print("\t".join(["Contig", "Length", "Start_Repeats_Count", "Start_Repeats_Length", "End_Repeats_Cound", "End_Repeats_Length", "Start_Telomere", "End_Telomere", "Start_Repeats", "End_Repeats"]))
...
for record in SeqIO.parse(fasta_file, "fasta"):
    ...
    print("\t".join(map(str, [sequence_id, len(sequence), len(hits_start), hits_start_length, len(hits_end), hits_end_length, start_telomere_found, end_telomere_found, hits_start, hits_end])))
