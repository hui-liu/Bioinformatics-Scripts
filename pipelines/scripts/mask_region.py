...
def lower(base):
	return base.lower()
def main(inSeq=sys.argv[1], inBed=sys.argv[2], soft=False, suffix=None, outSeq=sys.stdout):
	if soft:
...
if __name__ == '__main__':
	try: soft = sys.argv[3]
	except IndexError: soft = False
	main(inSeq=sys.argv[1], inBed=sys.argv[2], soft=soft)
