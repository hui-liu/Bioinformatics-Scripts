...
# detect gene cluster:
# (1) group by chrom: cluster located at different choromosomes was split into sub-cluster
# (2) group by distance: genes within 200 kb of each other in the genome
...
for g1, g2 in allpairs:
    ...
    g1_g2_span = (g2_start - g1_end) if (g1_order < g2_order) else (g1_start - g2_end)
    if g1_chrom == g2_chrom:
        # 200 kb
        if g1_g2_span <= 200000:
